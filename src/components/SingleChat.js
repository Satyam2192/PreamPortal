...
const SingleChat = ({ fetchAgain, setFetchAgain }) => {
  ...
  const setSelectedChat=func.setSelectedChat;
  const user=func.user;
  const notification=func.notification;
  const setNotification=func.setNotification;
  ...
  const sendMessage = async (event) => {
    if (event.key === "Enter" && newMessage) {
      ...
      try {
        ...
        setNewMessage("");
        console.log("message",newMessage,"chat",selectedChat._id)
